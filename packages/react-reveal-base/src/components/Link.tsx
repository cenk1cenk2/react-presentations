...
function getLinkFromSlide (reveal: Reveal<MightBeRevealPlugin[]> | null, slide: HTMLElement) {
  if (!reveal) {
    return '#'
  }
...
function getLink (reveal: Reveal<MightBeRevealPlugin[]> | null, href?: string, slide?: SlideType): string | ((e: React.MouseEvent) => void) {
  if (href) {
    return href
  }
  if (!slide) {
