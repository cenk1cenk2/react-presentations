...
import { ExtractPluginExtraConfig, RevealConfig, RevealPlugin, MightBeRevealPlugin } from '../../types/reveal.js/index'
...
export default function RevealJS<Extras, Plugins extends RevealPlugin<Extras>[]> ({ children,
  ...
  onDeckReady,
  pluginProps }: RevealJSProps<Plugins>) {
  ...
  const revealDeck: React.MutableRefObject<Reveal<Plugins> | null> = useRef(null)
