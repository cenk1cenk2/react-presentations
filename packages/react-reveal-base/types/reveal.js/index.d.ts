...
export type RevealPlugins<Plugins extends MightBeRevealPlugin[]> = Plugins extends RevealPluginDefinition<infer PluginConfig>[] ? RevealPlugin<PluginConfig>[] : never
...
export interface RevealConfigBase<Plugins extends MightBeRevealPlugin[]> {
  ...
  progress?: boolean
  slideNumber?: boolean | 'h.v' | 'h/v' | 'c' | 'c/t' | ((slide: { h: number, v: number, f: number }) => string | string[])
...
export type ExtractPluginExtraConfig<P extends MightBeRevealPlugin[]> = P extends RevealPlugin<infer ExtraConfig>[] ? UnionToIntersection<NoUndefined<ExtraConfig>> : never

export type RevealConfig<Plugins extends MightBeRevealPlugin[]> = RevealConfigBase<Plugins> & ExtractPluginExtraConfig<Plugins>
